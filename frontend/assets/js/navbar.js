document.addEventListener("DOMContentLoaded", () => {
    ...
    <div class="scroll-progress" id="scrollProgress"></div>
      <div class="max-w-[90%] mx-auto grid grid-cols-3 items-center justify-center h-20">
        <div class="flex items-center space-x-8">
          <a href="/" id="logo-link" class="flex items-center justify-start space-x-2">
            <img src="../assets/logo.png" alt="Logo" class="h-10" />
          </a>
        </div>
        <div class="flex items-center justify-center md:flex space-x-6">
          <a href="/dashboard" class="nav-link text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 relative">Dashboard
          ...
          <a href="/practice" class="nav-link text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 relative">Practice
            <span class="absolute bottom-0 left-0 w-full h-0.5 bg-blue-600 transform scale-x-0 transition-transform origin-left hover:scale-x-100"></span>
          </a>
          <a href="/resources" class="nav-link text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 relative">Resources
            <span class="absolute bottom-0 left-0 w-full h-0.5 bg-blue-600 transform scale-x-0 transition-transform origin-left hover:scale-x-100"></span>
          </a>
          ${
            isLoggedIn
              ? `
          <a href="/logout" class="nav-link text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 relative">Logout
            <span class="absolute bottom-0 left-0 w-full h-0.5 bg-blue-600 transform scale-x-0 transition-transform origin-left hover:scale-x-100"></span>
          </a>
          `
              : ""
  ...
  navLinks.forEach((link) => {
    if (link.id !== "logo-link" && link.pathname === currentPath) {
